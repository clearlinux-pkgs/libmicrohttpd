...
Version  : 0.9.50
Release  : 6
URL      : http://ftp.gnu.org/gnu/libmicrohttpd/libmicrohttpd-0.9.50.tar.gz
Source0  : http://ftp.gnu.org/gnu/libmicrohttpd/libmicrohttpd-0.9.50.tar.gz
...
%prep
%setup -q -n libmicrohttpd-0.9.50
