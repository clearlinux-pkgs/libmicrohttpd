...
Version  : 1.0.1
Release  : 36
URL      : https://mirrors.kernel.org/gnu/libmicrohttpd/libmicrohttpd-1.0.1.tar.gz
Source0  : https://mirrors.kernel.org/gnu/libmicrohttpd/libmicrohttpd-1.0.1.tar.gz
Source1  : https://mirrors.kernel.org/gnu/libmicrohttpd/libmicrohttpd-1.0.1.tar.gz.sig
...
%prep
%setup -q -n libmicrohttpd-1.0.1
cd %{_builddir}/libmicrohttpd-1.0.1
pushd ..
cp -a libmicrohttpd-1.0.1 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1708964245
...
%files lib
%defattr(-,root,root,-)
/V3/usr/lib64/libmicrohttpd.so.12.62.1
/usr/lib64/libmicrohttpd.so.12
/usr/lib64/libmicrohttpd.so.12.62.1
