...
Version  : 0.9.76
Release  : 33
URL      : https://mirrors.kernel.org/gnu/libmicrohttpd/libmicrohttpd-0.9.76.tar.gz
Source0  : https://mirrors.kernel.org/gnu/libmicrohttpd/libmicrohttpd-0.9.76.tar.gz
Source1  : https://mirrors.kernel.org/gnu/libmicrohttpd/libmicrohttpd-0.9.76.tar.gz.sig
...
%prep
%setup -q -n libmicrohttpd-0.9.76
cd %{_builddir}/libmicrohttpd-0.9.76
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1677537555
