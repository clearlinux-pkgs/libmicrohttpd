...
#
# Source0 file verified with key 0xBF7AC4A5EAC2BAF4 (k2k@narod.ru)
#
Name     : libmicrohttpd
Version  : 0.9.53
Release  : 11
...
%prep
%setup -q -n libmicrohttpd-0.9.53

%build
export LANG=C
export SOURCE_DATE_EPOCH=1492017531
...
/usr/lib64/libmicrohttpd.so.12.41.0
